                                    ...
                                    <div key={c.candidateId} className="relative">
                                        <div className="flex items-center gap-4 relative z-10 mb-2">
                                            ...
                                            <div className="relative">
                                                {c.photoUrl ? (
                                                    <img src={c.photoUrl} alt="" className="w-14 h-14 rounded-full object-cover border-2 shadow-lg"
                                                        style={{ borderColor: c.themeColor }} crossOrigin="anonymous" />
                                                ) : (
                                                    <div className="w-14 h-14 rounded-full flex items-center justify-center text-white text-lg font-bold border-2 shadow-lg"
